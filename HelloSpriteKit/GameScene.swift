...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        field.region = SKRegion(radius: Float(300))
        field.strength = 6
        field.falloff = 2
        ...
        caldron = SKShapeNode(rectOf: CGSize(width: caldronSize, height: caldronSize), cornerRadius: 10)
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        copy.physicsBody?.fieldBitMask = BitMask.mask1.rawValue
